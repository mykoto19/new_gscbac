            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <!-- Page Heading -->
                        <h1 class="h5 mb-2 text-gray-800">Goods</h1>
                    </div>
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    ...
                                                    <?php 
                                                        ...
                                                        $query = "SELECT * FROM goods_items WHERE goodsID = 1";
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    ...
                                                    <?php 
                                                        ...
                                                        $query = "SELECT * FROM goods_items WHERE goodsID = 2";
                                                        $goods = mysqli_query($db,$query);
                                                        if(!$goods){
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    ...
                                                    <?php 
                                                        ...
                                                        $query = "SELECT * FROM goods_items WHERE goodsID = 3";
                                                        $goods = mysqli_query($db,$query);
                                                        if(!$goods){
