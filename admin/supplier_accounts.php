            ...
            <div id="content">
                ...
                <div class="container-fluid">
                	...
                	<div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Manage Supplier Accounts</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4 m-5">
                        <div class="card-header py-3 text-right pr-5">
                            ...
                            <h4><a href="add_supplier.php" class="m-0 font-weight-bold text-primary">Add Account</a></h4>
                                ...
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div><?= $supplier_fname; ?> <?= $supplier_lname; ?></div>
                                            </td>
                                            ...
                                            <td>
                                               ...
                                               <a href="edit_supplier.php?edit=<?php echo $supplier_id_db; ?>" class="btn btn-md" type="button" title="Edit"><i class="fas fa-fw fa-edit"></i> Edit</a>

                                                <a onclick="return confirm('Are you sure you want to delete this item?');" href="delete_item.php?delete_supplier=<?php echo $supplier_id_db; ?>" type="button" class="btn btn-md" title="Delete"><i class="fas fa-fw fa-trash"></i> Delete</a>
