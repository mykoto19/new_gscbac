                        ...
                        <div class="col-lg-6 mb-4 mx-auto">
                            ...
                            <div class="card border-left-primary border-bottom-primary shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-user text-gray-800 mr-2"></i> Update Admin</h6>
                                </div>
                                <div class="card-body">
                                ...
                                <?php
                                	...
                                	if(isset($_POST['submit'])){
                                            ...
                                            $pass = mysqli_real_escape_string($db,$pass);
						                     ...
						                     $query = "UPDATE admintb SET admin_fname = '{$fname}', admin_lname = '{$lname}', AdminName = '{$adminName}' , AdminPass = '{$pass}' WHERE AdminID = {$edit_id} ";
                                                $update_query = mysqli_query($db,$query);
                                                if($update_query){
                                                    header("Location: admin_accounts.php?success=Your item updated succesfully!");
                                                    exit();
                                                }else{
                                                    header("Location: edit_admin.php?error=Unknown error occured");
                                                    exit();
                                                }
						           ...
						           ?>
                                	 ...
                                	 <?php 
						                ...
						                $query = "SELECT * FROM admintb WHERE AdminID = {$edit_id}";
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-5 m-3">
                                                  <div>First Name:</div>
                                                  <input type="text" name="fname" required="" value="<?= $fname; ?>">
                                                </div>
                                                ...
                                                <div class="col-sm-12 m-3">
                                                  ...
                                                  <input type="text" name="adminName" required="" value="<?= $adminName; ?>">
                                                </div>
