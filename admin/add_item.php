                        ...
                        <div class="col-lg-6 mb-4 mx-auto">
                            ...
                            <div class="card border-left-primary border-bottom-primary shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-table text-gray-800 mr-2"></i> Add Item</h6>
                                </div>
                                <div class="card-body">

                                    <form action="add_item_check.php" method="post">
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-5 m-1">
                                                    ...
                                                    <div>Item Type :</div>
                                                    <input type="text" name="itemType" class="span11" placeholder="Item Type" required="" />
                                                ...
                                                <div class="col-sm-5 m-1">
                                                    ...
                                                    <div>Item Name :</div>
                                                    <input type="text" name="itemName" class="span11" placeholder="Item Name" required="" />
                                                 ...
                                                 <div class="col-sm-12 m-1">
                                                    ...
                                                    <textarea name="itemDetails" id="" cols="30" rows="10" class="span11" required=""></textarea>
                                                ...
                                                <div class="col-sm-12 m-1">
                                                    ...
                                                    <div>Item Cost :</div>
                                                    <input type="number" name="itemCost" class="span11" required="" />
