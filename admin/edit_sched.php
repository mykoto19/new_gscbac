            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="bac_sched.php">BAC Schedules</a>
...
?>
                ...
                <div class="container-fluid">
                  <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">BAC Schedules</h1>
                        ...
                        <div class="col-lg-10 mb-4 mx-auto">
                            ...
                            <div class="card border-left-primary border-bottom-primary shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-table text-gray-800 mr-2"></i> Update Schedule</h6>
                                </div>
                                <div class="card-body">
                                ...
                                <?php
                                	...
                                	if(isset($_POST['submit'])){
						                    ...
						                    $activities = mysqli_real_escape_string($db,$activities);
						                    $timeline = mysqli_real_escape_string($db,$timeline);
						                    $goodsID = mysqli_real_escape_string($db,$goodsID);

						                    $query = "UPDATE proj_sched SET sched_date = '{$sched_date}', day_time = '{$day_time}', activities = '{$activities}' , timeline = '{$timeline}', sched_id = '{$sched_id}' WHERE ID = {$edit_id} ";
						                    $update_query = mysqli_query($db,$query);
						                    if($update_query){

						                        header("Location: bac_sched.php?success=$edit_id");
						                        exit();
						                    }else{
						                        header("Location: edit_sched.php?error=Unknown error occured");
						                        exit();
						                    }
						           ...
						           ?>
                                	 ...
                                	 <?php 
						                ...
						                $query = "SELECT * FROM proj_sched WHERE ID = {$edit_id}";
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 m-3">
                                                    <div>Schedule ID:</div>
                                                    <input type="text" name="sched_id" required="" value="<?= $sched_id; ?>">
                                                </div>
                                                ...
                                                <div class="col-sm-3 m-3">
                                                    ...
                                                    <input type="text" name="sched_date" autofocus="" required="" value="<?= $sched_date; ?>">
                                                </div>


                                                <div class="col-sm-3 m-3">
                                                    <div>Day/Time:</div>
                                                    <input type="text" name="day_time" required="" value="<?= $day_time; ?>">
                                                </div>


                                                <div class="col-sm-3 m-3">
                                                    <div>Timeline:</div>
                                                    <input type="text" name="timeline" required="" value="<?= $timeline; ?>">
                                                </div>
                                                 ...
                                                 <div class="col-sm-5 m-3">
                                                    ...
                                                    <div>Activities</div>
                                                    <textarea name="activity" id="" cols="100" rows="10" class="span11" required=""><?= $activities; ?></textarea>
