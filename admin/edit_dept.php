            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="department_accounts.php">Department/Offices</a>
...
?>
                ...
                <div class="container-fluid">
                  <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Manage Department/Office Accounts</h1>
                        ...
                        <div class="col-lg-12 mb-4 mx-auto">
                            ...
                            <div class="card border-left-primary border-bottom-primary shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-user text-gray-800 mr-2"></i> Update Department/Office</h6>
                                </div>
                                <div class="card-body">
                                ...
                                <?php
                                	...
                                	if(isset($_POST['submit'])){
                                            ...
                                            $pass = mysqli_real_escape_string($db,$pass);
						                     ...
						                     $query = "UPDATE departmenttb SET College_Office = '{$dept_name}', acro_name = '{$acronym}', Title = '{$title}', head_lname = '{$lname}', head_fname = '{$fname}', head_mid_init = '{$mname}', deptName = '{$usr}', deptPass = '{$pass}' WHERE deptID = {$edit_id} ";
                                                $update_query = mysqli_query($db,$query);
                                                if($update_query){
                                                    header("Location: view_dept_accounts.php?success=BAC composition updated succesfully!");
                                                    exit();
                                                }else{
                                                    header("Location: edit_dept.php?error=Unknown error occured");
                                                    exit();
                                                }
						           ...
						           ?>
                                	 ...
                                	 <?php 
						                ...
						                $query = "SELECT * FROM departmenttb WHERE deptID = {$edit_id}";
                                        $select_update_query = mysqli_query($db,$query);
                                        CheckQuery($select_update_query);

                                        while($row = mysqli_fetch_assoc($select_update_query)){

                                            $dept_name = $row['College_Office'];
                                            $acronym = $row['acro_name'];
                                            $title = $row['Title'];
                                            $lname = $row['head_lname'];
                                            $fname = $row['head_fname'];
                                            $mname = $row['head_mid_init'];
                                            $usr = $row['deptName'];
                                            $pass = $row['deptPass'];
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 m-3">
                                                    ...
                                                    <input type="text" name="dept_name" class="w-100" value="<?= $dept_name; ?>">
                                                    <div class="m-3"></div>
                                                    <input type="text" name="acronym" value="<?= $acronym; ?>">
                                                </div>
                                                ...
                                                <div class="col-sm-3 m-3">
                                                    ...
                                                    <input type="text" name="lname" value="<?= $lname; ?>" class="w-100">
                                                </div>


                                                <div class="col-sm-3 m-3">
                                                    
                                                    <input type="text" name="fname" value="<?= $fname; ?>" class="w-100">
                                                </div>
