            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <!-- Page Heading -->
                        <h1 class="h5 mb-2 text-gray-800"><a href="service.php">Services</a> > Repair and Maintenance</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4 m-5">
                        ...
                        <div class="card-header py-3 pr-5">      

                            <h4 class="text-right"><a href="add_service.php" class="m-0 font-weight-bold text-primary">Add Item</a></h4>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div>
                                                    ...
                                                    <a href="edit_service.php?edit=<?php echo $service_id_db; ?>" class="btn btn-md" type="button" title="Edit"><i class="fas fa-fw fa-edit"></i> Edit</a>

                                                    <a onclick="return confirm('Are you sure you want to delete this item?');" href="delete_item.php?delete_service=<?php echo $service_id_db; ?>" type="button" class="btn btn-md" title="Delete"><i class="fas fa-fw fa-trash"></i> Delete</a>
