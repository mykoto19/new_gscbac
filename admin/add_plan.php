                        ...
                        <div class="col-lg-6 mb-4 mx-auto">
                            ...
                            <div class="card border-left-primary border-bottom-primary shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="add_plan_check.php" method="post">
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-5 m-1">
                                                    ...
                                                    <input type="text" name="plan_item" class="span11" required="" />
                                                 ...
                                                 <div class="col-sm-12 m-1">
                                                    ...
                                                    <textarea name="plan_details" id="" cols="30" rows="10" class="span11" required=""></textarea>
                                                ...
                                                <div class="col-sm-12 m-1">
                                                    ...
                                                    <input type="number" name="plan_cost" class="span11" required="" />
