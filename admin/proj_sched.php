        ...
        ?>
                ...
                <div class="container-fluid">
                	...
                	<div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">BAC Schedules</h1>
			                    ...
			                    <div class="card shadow mb-4 m-5 mx-auto w-100">
			                        <div class="card-header py-3 text-right pr-5">
                                        ...
                                        <?php 
                                            ...
                                            $mysql = "SELECT * FROM schedules WHERE sched_id = {$source_id}";
                                            $query = mysqli_query($db,$mysql);
                                            while($name = mysqli_fetch_assoc($query)){

                                                $id_db = $name['sched_id'];
                                                $sched_name = $name['sched_name'];



                                        ?>
			                            
			                            <h4 class="m-0 font-weight-bold text-primary"><?php echo $sched_name; ?></h4>
                                            ...
                                            <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php 
                                                                ...
                                                                $sql = "SELECT * FROM proj_sched WHERE sched_id = {$source_id}";
                                                            ...
                                                            ?>
                                                             ...
                                                             <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="edit_sched.php?edit=<?php echo $proj_sched_id; ?>" class="btn btn-md" type="button" title="Edit"><i class="fas fa-fw fa-edit"></i> Edit</a>

                                                                    <a onclick="return confirm('Are you sure you want to delete this item?');" href="delete_item.php?delete_proj_sched=<?php echo $proj_sched_id; ?>" type="button" class="btn btn-md" title="Delete"><i class="fas fa-fw fa-trash"></i> Delete</a>
