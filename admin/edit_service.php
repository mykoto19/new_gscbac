            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="service.php">Services</a>
                            ...
                            <div class="card border-left-primary border-bottom-primary shadow mb-4">
                                ...
                                <?php
                                	...
                                	if(isset($_POST['submit'])){
						                    ...
						                    $query = "UPDATE service_offer SET serveOffer_Name = '{$service_item}', serveOffer_Details = '{$service_details}' , serveOffer_Cost = '{$service_cost}', serviceID = '{$serviceID}' WHERE serveOffer_ID = {$edit_id} ";
						                    $update_query = mysqli_query($db,$query);
						                    if($update_query){

						                        header("Location: service.php?success=Your item updated succesfully!");
						                        exit();
						                    }else{
						                        header("Location: edit_service.php?error=Unknown error occured");
						                        exit();
						                    }
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 m-1">
                                                    <div>Select list:</div>
                                                    <select id="sel1" name="serviceID" value="<?php echo $serviceID; ?>">
                                                        <option></option>
                                                        <option value="1">Internet</option>
                                                        <option value="2">Repair and Maintenance</option>
                                                ...
                                                <div class="col-sm-5 m-1">
                                                    ...
                                                    <input type="text" name="service_item" class="span11" value="<?php echo $service_item; ?>" />
                                                 ...
                                                 <div class="col-sm-12 m-1">
                                                    ...
                                                    <textarea name="service_details" id="" cols="30" rows="10" class="span11"><?php echo $service_details; ?></textarea>
                                                ...
                                                <div class="col-sm-12 m-1">
                                                    ...
                                                    <input type="number" name="service_cost" class="span11" value="<?php echo $service_cost; ?>" />
