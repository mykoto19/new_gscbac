                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                     ...
                     <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <!-- View Department Account Card Example -->
                                <div class="col-xl-3 col-md-6 mb-4">
                                    <a href="view_dept_accounts.php">
                                                ...
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col mr-2">
                                                        <div class="text-xs font-weight-bold text-light text-uppercase mb-1 text-center">
                                                            View Department/Office Accounts</div>
                                 ...
                                 <!-- Add Department Account Card Example -->
                                <div class="col-xl-3 col-md-6 mb-4">
                                    <a href="add_dept.php">
                                        <div class="card border-left-primary shadow h-100 py-3 bg-warning">
                                            <div class="card-body">
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col mr-2">
                                                        <div class="text-xs font-weight-bold text-light text-uppercase mb-1 text-center">
                                                            Add Department/Office Account</div>
                            ...
                            <div class="row">
                                ...
                                <?php 
                                            ...
                                            while($row = mysqli_fetch_assoc($result)){
                                              ...
                                              $department_id_db = $row['deptID'];
                                              $dept_name = $row['College_Office'];
                                              $dept_user = $row['deptName'];
