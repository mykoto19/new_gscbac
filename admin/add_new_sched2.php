            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="create_sched.php">Create Schedule</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                	...
                	<div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Add New Schedule</h1>
                        ...
                        <div class="col-lg-10 mb-4 mx-auto">
                            ...
                            <div class="card border-left-primary border-bottom-primary shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-calendar text-gray-800 mr-2"></i> BAC Schedule</h6>
                                </div>
                                <div class="card-body">

                                    <form action="add_newSched2_check.php" method="post">
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 m-4 ml-4">
                                                    <div class="mr-5 pr-5">Schedule ID:</div>
                                                    <input type="number" name="sched_id" required="" value="<?= $sched_id;?>">
                                                </div>
                                                ...
                                                <div class="col-sm-3 m-4">
                                                    ...
                                                    <input type="text" name="sched_date" required="" autofocus="">
                                                </div>


                                                <div class="col-sm-3 m-4">
                                                    <div>Day/Time:</div>
                                                    <input type="text" name="day_time" required="">
                                                </div>
                                                ...
                                                <div class="col-sm-3 m-4">
                                                 ...
                                                 <div class="col-sm-5 m-3">
                                                    ...
                                                    <div>Activities</div>
                                                    <textarea name="activity" id="" cols="90" rows="10" class="span11" required=""></textarea>
