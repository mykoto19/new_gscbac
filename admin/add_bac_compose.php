            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Add Committee Position</h1>
                    </div>
                            ...
                            <div class="card border-left-primary border-bottom-primary shadow mb-4">
                                <div class="card-header py-3">
                                    <a href="manage_bac_compose.php">
                                        <h6 class="m-0 font-weight-bold text-primary text-right"> Back</h6>
                                    </a>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="row">
                                            ...
                                            <form action="add_bac_check.php" method="post">
                                                ...
                                                <div class="container-fluid">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12 m-3">
                                                            ...
                                                            <select id="sel1" name="position" class="w-50">
                                                                <option></option>
                                                                <option>Chair</option>
                                                        ...
                                                        <div class="col-sm-12 m-3">
                                                            ...
                                                            <div>Name:</div>
                                                            <input type="text" name="name" class="w-100" placeholder="Input Full Name" required="" />
