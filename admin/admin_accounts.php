                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4 m-5">
                        <div class="card-header py-3 text-right pr-5">
                            ...
                            <h4><a href="add_admin.php" class="m-0 font-weight-bold text-primary">Add Account</a></h4>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div><?= $admin_lname; ?>, <?= $admin_fname; ?></div>
                                            </td>
                                            ...
                                            <td>
                                               ...
                                               <a href="edit_admin.php?edit=<?php echo $admin_id_db; ?>" class="btn btn-md" type="button" title="Edit"><i class="fas fa-fw fa-edit"></i> Edit</a>

                                                <a onclick="return confirm('Are you sure you want to delete this item?');" href="delete_item.php?delete_admin=<?php echo $admin_id_db; ?>" type="button" class="btn btn-md" title="Delete"><i class="fas fa-fw fa-trash"></i> Delete</a>
