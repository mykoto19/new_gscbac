            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <!-- Page Heading -->
                        <h1 class="h5 mb-2 text-gray-800"><a href="planning.php">Planning</a> > Repair and Maintenance</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4 m-5">
                        <div class="card-header py-3 text-right pr-5">
                            ...
                            <h4><a href="add_plan.php" class="m-0 font-weight-bold text-primary">Add Item</a></h4>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div>
                                                    ...
                                                    <a href="edit_plan.php?edit=<?php echo $plan_id_db; ?>" class="btn btn-md" type="button" title="Edit"><i class="fas fa-fw fa-edit"></i> Edit</a>

                                                    <a onclick="return confirm('Are you sure you want to delete this item?');" href="delete_item.php?delete_plan=<?php echo $plan_id_db; ?>" type="button" class="btn btn-md" title="Delete"><i class="fas fa-fw fa-trash"></i> Delete</a>
