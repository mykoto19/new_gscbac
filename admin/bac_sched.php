			                                    ...
			                                    <tbody>
					                                ...
					                                <?php 
					                                            ...
					                                            while($row = mysqli_fetch_assoc($result)){
					                                              ...
					                                              $sched_id_db = $row['sched_id'];
					                                              $sched_name = $row['sched_name'];
					                                        ...
					                                        ?>
					                                		 ...
					                                		 <tr>
					                                            ...
					                                            <td>
					                                               ...
					                                               <a href="proj_sched.php?source=<?php echo $sched_id_db; ?>" class="btn btn-sm btn-primary" type="button" title="Check"><i class="fas fa-fw fa-folder"></i> Check Schedule</a>


                                                                   <a onclick="return confirm('Are you sure you want to delete this item?');" href="delete_item.php?delete_sched=<?php echo $sched_id_db; ?>" type="button" class="btn btn-sm btn-danger w-25" title="Delete"><i class="fas fa-fw fa-trash"></i> Delete</a>
