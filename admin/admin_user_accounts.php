                         ...
                         <!-- Earnings (Monthly) Card Example -->
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <a href="admin_accounts.php">
                                    <div class="card border-left-primary shadow h-100 py-3 bg-success">
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-light text-uppercase mb-1 text-center">
                                                        View ADMINS</div>
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <a href="add_admin.php">
                                    <div class="card border-left-primary shadow h-100 py-3 bg-warning">
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-light text-uppercase mb-1 text-center">
                             ...
                             <!-- Earnings (Monthly) Card Example -->
                            <div class="col-xl-3 col-md-6 mb-4">
                                <a href="bac_compose.php">
                                    <div class="card border-left-primary shadow h-100 py-3 bg-secondary">
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-light text-uppercase mb-1 text-center">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    ...
                                                    <?php 
                                                        ...
                                                        $admin_accounts = mysqli_query($db,$query);
                                                        if(!$admin_accounts){

                                                            die("Query Failed". mysqli_error($db));
                                                        }

                                                        $result = mysqli_num_rows($admin_accounts);

                                                    ?>

                                                    <div class="h5 mb-0 font-weight-bold text-gray-800 text-center"><?php echo $result; ?></div>
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    ...
                                                    <?php 
                                                        ...
                                                        $query = "SELECT * FROM departmenttb";
                                                        $dept_accounts = mysqli_query($db,$query);
                                                        if(!$dept_accounts){

                                                            die("Query Failed". mysqli_error($db));
                                                        }

                                                        $result = mysqli_num_rows($dept_accounts);
                                                    ...
                                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-0 text-center">
                                                        Department Accounts</div>
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    ...
                                                    <?php 
                                                        ...
                                                        $query = "SELECT * FROM officetb";
                                                        $ofc_accounts = mysqli_query($db,$query);
                                                        if(!$ofc_accounts){

                                                            die("Query Failed". mysqli_error($db));
                                                        }

                                                        $result = mysqli_num_rows($ofc_accounts);
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    ...
                                                    <?php 
                                                        ...
                                                        $query = "SELECT * FROM suppliertb";
                                                        $sup_accounts = mysqli_query($db,$query);
                                                        if(!$sup_accounts){

                                                            die("Query Failed". mysqli_error($db));
                                                        }

                                                        $result = mysqli_num_rows($sup_accounts);
