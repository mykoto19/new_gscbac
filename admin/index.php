                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-warehouse fa-2x text-gray-650"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php 
                                                ...
                                                $query = "SELECT * FROM plan_infra";
                                                $plan = mysqli_query($db,$query);
                                                if(!$plan){

                                                    die("Query Failed". mysqli_error($db));
                                                }

                                                $result = mysqli_num_rows($plan);
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php 
                                                ...
                                                $query = "SELECT * FROM service_offer";
                                                $service = mysqli_query($db,$query);
                                                if(!$service){

                                                    die("Query Failed". mysqli_error($db));
                                                }

                                                $result = mysqli_num_rows($service);
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-user fa-2x text-gray-650"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php 
                                                ...
                                                $result = mysqli_num_rows($department);
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php 
                                                ...
                                                $supplier = mysqli_query($db,$query);
                                                if(!$supplier){

                                                    die("Query Failed". mysqli_error($db));
                                                }

                                                $result = mysqli_num_rows($supplier);
