            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="goods.php">Goods</a>
...
?>
                ...
                <div class="container-fluid">
                  <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Goods</h1>
                        ...
                        <div class="col-lg-6 mb-4 mx-auto">
                            ...
                            <div class="card border-left-primary border-bottom-primary shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-table text-gray-800 mr-2"></i> Update Item</h6>
                                </div>
                                <div class="card-body">
                                ...
                                <?php
                                	...
                                	if(isset($_POST['submit'])){
						                    ...
						                    $query = "UPDATE goods_items SET itemName = '{$itemName}', itemType = '{$itemType}', itemDetails = '{$itemDetails}' , itemCost = '{$itemCost}', goodsID = '{$goodsID}' WHERE itemID = {$edit_id} ";
						                    $update_query = mysqli_query($db,$query);
						                    if($update_query){

						                        header("Location: goods.php?success=Your item updated succesfully!");
						                        exit();
						                    }else{
						                        header("Location: edit_item.php?error=Unknown error occured");
						                        exit();
						                    }
						           ...
						           ?>
                                	 ...
                                	 <?php 
						                ...
						                $query = "SELECT * FROM goods_items WHERE itemID = {$edit_id}";
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 m-1">
                                                    <div>Select list:</div>
                                                    <select id="sel1" name="goodsID" value="<?php echo $goodsID; ?>">
                                                    	<option></option>
                                                        <option value="1">Office Supplies</option>
                                                        <option value="2">Medical Supplies</option>
                                                        <option value="3">Other Supplies</option>
                                                    </select>
                                                </div>
                                                 ...
                                                 <div class="col-sm-5 m-1">
                                                    ...
                                                    <div>Item Type :</div>
                                                    <input type="text" name="itemType" class="span11" placeholder="Item Type" value="<?php echo $itemType; ?>" />
                                                ...
                                                <div class="col-sm-5 m-1">
                                                    ...
                                                    <div>Item Name :</div>
                                                    <input type="text" name="itemName" class="span11" placeholder="Item Name" value="<?php echo $itemName; ?>" />
                                                 ...
                                                 <div class="col-sm-12 m-1">
                                                    ...
                                                    <textarea name="itemDetails" id="" cols="30" rows="10" class="span11"><?php echo $itemDetails; ?></textarea>
                                                ...
                                                <div class="col-sm-12 m-1">
                                                    ...
                                                    <div>Item Cost :</div>
                                                    <input type="number" name="itemCost" class="span11" value="<?php echo $itemCost; ?>" />
