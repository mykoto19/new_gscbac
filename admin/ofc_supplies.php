            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <!-- Page Heading -->
                        <h1 class="h5 mb-2 text-gray-800"><a href="goods.php">Goods</a> > Office Supplies</h1>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div>
                                                    ...
                                                    <a onclick="return confirm('Are you sure you want to delete this item?');" href="delete_item.php?delete_item_ofc=<?php echo $items_id_db; ?>" type="button" class="btn btn-md" title="Delete"><i class="fas fa-fw fa-trash"></i> Delete</a>
