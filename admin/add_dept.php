            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Manage Department Accounts</h1>
                    </div>
                        ...
                        <div class="col-lg-12 mb-4 mx-auto">
                            ...
                            <div class="card border-left-primary border-bottom-primary shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-user text-gray-800 mr-2"></i> Add Department/Office</h6>
                                </div>
                                <div class="card-body">

                                    <form action="add_dept_check.php" method="post">
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 m-3">
                                                    ...
                                                    <input type="text" name="dept_name" required="" class="w-100" placeholder="Full Department/Office Name">
                                                    <div class="m-3"></div>
                                                    <input type="text" name="acronym" required="" placeholder="Acronym">
                                                </div>
                                                ...
                                                <div class="col-sm-3 m-3">
                                                    ...
                                                    <input type="text" name="lname" required="" placeholder="Lastname" class="w-100">
                                                </div>


                                                <div class="col-sm-3 m-3">
                                                    
                                                    <input type="text" name="fname" required="" placeholder="Firstname" class="w-100">
                                                </div>

                                                <div class="col-sm-3 m-3">
                                                    
                                                    <input type="text" name="mname" required="" placeholder="M.I.">
                                                </div>
