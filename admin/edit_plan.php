...
<!-- Begin Page Content -->
                <div class="container-fluid">
                  <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Planning</h1>
                            ...
                            <div class="card border-left-primary border-bottom-primary shadow mb-4">
                                ...
                                <?php
                                	...
                                	if(isset($_POST['submit'])){
						                    ...
						                    $query = "UPDATE plan_infra SET planInfra_Name = '{$plan_item}', planInfra_Details = '{$plan_details}' , planInfra_Cost = '{$plan_cost}', planID = '{$planID}' WHERE planInfra_ID = {$edit_id} ";
						                    $update_query = mysqli_query($db,$query);
						                    if($update_query){

						                        header("Location: planning.php?success=Your item updated succesfully!");
						                        exit();
						                    }else{
						                        header("Location: edit_plan.php?error=Unknown error occured");
						                        exit();
						                    }
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 m-1">
                                                    <div>Select list:</div>
                                                    <select id="sel1" name="planID" value="<?php echo $planID; ?>">
                                                        <option></option>
                                                        <option value="1">Construction Supplies</option>
                                                        <option value="2">Infrastructures</option>
                                                ...
                                                <div class="col-sm-5 m-1">
                                                    ...
                                                    <div>Planning Item :</div>
                                                    <input type="text" name="plan_item" class="span11" value="<?php echo $plan_item; ?>" />
                                                 ...
                                                 <div class="col-sm-12 m-1">
                                                    ...
                                                    <div>Planning Item Details</div>
                                                    <textarea name="plan_details" id="" cols="30" rows="10" class="span11"><?php echo $plan_details; ?></textarea>
                                                ...
                                                <div class="col-sm-12 m-1">
                                                    ...
                                                    <div>Planning Item Cost :</div>
                                                    <input type="number" name="plan_cost" class="span11" value="<?php echo $plan_cost; ?>" />
