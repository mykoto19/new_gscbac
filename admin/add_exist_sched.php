            ...
            <div id="content">
                ...
                <div class="container-fluid">
                	...
                	<div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Add to Existing Schedule</h1>
                        ...
                        <div class="col-lg-10 mb-4 mx-auto">
                            ...
                            <div class="card border-left-primary border-bottom-primary shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="add_existSched_check.php" method="post">
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 m-3">
                                                    <div>Schedule ID:</div>
                                                    <input type="text" name="sched_id" required="" value="<?= $source_id; ?>">
                                                </div>
                                                ...
                                                <div class="col-sm-3 m-3">
                                                 ...
                                                 <div class="col-sm-5 m-3">
                                                    ...
                                                    <div>Activities</div>
                                                    <textarea name="activity" id="" cols="88" rows="10" class="span11" required=""></textarea>
