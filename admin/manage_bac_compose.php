                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4 m-5">
                        <div class="card-header py-3 text-right pr-5">
                            ...
                            <h6><a href="add_bac_compose.php" class="m-0 font-weight-bold text-primary"><i class="fas fa-male text-gray-800 mr-2"></i>Add BAC Composition</a></h6>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               ...
                                               <a href="edit_bac.php?edit=<?php echo $bacID; ?>" class="btn btn-md" type="button" title="Edit"><i class="fas fa-fw fa-edit"></i> Edit</a>

                                                <a onclick="return confirm('Are you sure you want to delete this item?');" href="delete_item.php?delete_bac_compose=<?php echo $bacID; ?>" type="button" class="btn btn-md" title="Delete"><i class="fas fa-fw fa-trash"></i> Delete</a>
