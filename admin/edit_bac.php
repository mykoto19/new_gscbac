...
?>
                ...
                <div class="container-fluid">
                  <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Manage BAC Composition</h1>
                        ...
                        <div class="col-lg-6 mb-4 mx-auto">
                            ...
                            <div class="card border-left-primary border-bottom-primary shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-user text-gray-800 mr-2"></i> Update BAC</h6>
                                </div>
                                <div class="card-body">
                                ...
                                <?php
                                	...
                                	if(isset($_POST['submit'])){
                                            ...
                                            $position = mysqli_real_escape_string($db,$position);
						                     ...
						                     $query = "UPDATE bac_compose SET Name = '{$name}', Position = '{$position}' WHERE ID = {$edit_id} ";
                                                $update_query = mysqli_query($db,$query);
                                                if($update_query){
                                                    header("Location: manage_bac_compose.php?success=BAC composition updated succesfully!");
                                                    exit();
                                                }else{
                                                    header("Location: edit_bac.php?error=Unknown error occured");
                                                    exit();
                                                }
						           ...
						           ?>
                                	 ...
                                	 <?php 
						                ...
						                $query = "SELECT * FROM bac_compose WHERE ID = {$edit_id}";
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 m-3">
                                                    ...
                                                    <select id="sel1" name="position" class="w-50" value="<?= $position; ?>">
                                                        <option></option>
                                                        <option>Chair</option>
                                                        <option>Vice-Chair</option>
                                                        <option>Regular Member</option>
                                                        <option>Alternate Member</option>
                                                ...
                                                <div class="col-sm-12 m-3">
                                                    ...
                                                    <div>Name:</div>
                                                    <input type="text" name="name" class="w-100" placeholder="Input Full Name" value="<?= $name; ?>" />
