                        ...
                        <div class="row">
                            ...
                            <!-- Add New Schedule Card -->
                                <div class="col-xl-4 col-md-6 mb-4">
                                    <a href="add_new_sched.php">
                                        <div class="card border-left-secondary border-bottom-secondary shadow h-100 py-5 bg-primary">
                                            <div class="card-body">
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col mr-2">
                                                        <div class="text-xs font-weight-bold text-light text-uppercase mb-1 text-center">
                                                            Add New Schedule</div>
                            ...
                            <!-- Add Existing Schedule Card -->
                                <div class="col-xl-4 col-md-6 mb-4">
                                    <a href="choose_sched.php">
                                        <div class="card border-left-secondary border-bottom-secondary shadow h-100 py-5 bg-primary">
                                            <div class="card-body">
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col mr-2">
                                                        <div class="text-xs font-weight-bold text-light text-uppercase mb-1 text-center">
                                                            Add to the Existing Schedule</div>
