            ...
            <div id="content">
                ...
                <div class="container-fluid">
                	...
                	<div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Department Accounts</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4 m-5">
                        <div class="card-header py-3 text-right pr-5">
                            ...
                            <h4><a href="add_dept.php" class="m-0 font-weight-bold text-primary">Add Account</a></h4>
                                    ...
                                    <tbody>
                                         ...
                                         <?php 
                                            ...
                                            while($row = mysqli_fetch_assoc($result)){
                                              ...
                                              $dept_id_db = $row['deptID'];
                                              $department = $row['College_Office'];
                                              $acronym = $row['acro_name'];
                                              $username = $row['deptName'];
                                              $head_lname = $row['head_lname'];
                                              $head_fname = $row['head_fname'];
                                              $head_mid_init = $row['head_mid_init'];
                                              $title = $row['Title'];
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            	<div><?= $title; ?> <?= $head_fname; ?> <?= $head_mid_init; ?> <?= $head_lname; ?></div>
                                            </td>

                                            <td>

                                               <a href="edit_dept.php?edit=<?php echo $dept_id_db; ?>" class="btn btn-md" type="button" title="Edit"><i class="fas fa-fw fa-edit"></i> Edit</a>

                                                <a onclick="return confirm('Are you sure you want to delete this item?');" href="delete_item.php?delete_dept=<?php echo $dept_id_db; ?>" type="button" class="btn btn-md" title="Delete"><i class="fas fa-fw fa-trash"></i> Delete</a>
